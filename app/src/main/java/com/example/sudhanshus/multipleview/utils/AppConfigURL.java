...
public class AppConfigURL {
    ...
    public static String URL_LOGIN = BASE_URL + "userLogin";
    public static String URL_REGISTER = BASE_URL + "userRegister";
    public static String URL_SAVE_CONTACT = BASE_URL + "saveContacts";
